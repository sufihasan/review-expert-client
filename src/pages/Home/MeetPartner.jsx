...
const MeetPartner = () => {
    return (
        <div className='w-11/12 mx-auto my-15 dark:text-gray-200'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-5 gap-5  md:gap-10 mt-5'>
                ...
                <div className='border border-gray-100  dark:border-slate-700 rounded p-3'>
                ...
                <div className='border border-gray-100 dark:border-slate-700 rounded p-3'>
                    <div className='flex items-center justify-center '>
                        <img className='w-20 h-20' src="https://i.ibb.co.com/kV1Y8Fxs/cyberbg1gs.png" alt="" />
                        <h3>CyberSafe</h3>
                    </div>
